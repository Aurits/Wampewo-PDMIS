     ...
     <div class="main-panel">
       ...
       <main>
         <div class="container">
           ...
           <h2>PDM Overview</h2>
           <?php
            // Fetch and display PDM Overview content from the database
            $sql = "SELECT Content FROM Information_Pages WHERE Page_Name = 'PDM Overview'";
           ...
           <h2>PDM Pillars</h2>
           <?php
            // Fetch and display PDM Pillars content from the database
            $sql = "SELECT Content FROM Information_Pages WHERE Page_Name = 'PDM Pillars'";
            $result = mysqli_query($conn, $sql);
            $row = mysqli_fetch_assoc($result);
            echo "<p>" . $row['Content'] . "</p>";
            ?>

           <!-- Add other sections and information based on the PDM -->
         </div>
       </main>
